...
import { Trash2, Edit, Plus, ArrowLeft, X, CheckCircle } from 'lucide-react';
import { useState } from 'react';
import {
    store,
    update,
    destroy,
} from '@/actions/App/Http/Controllers/Admin/QuestionController';
            ...
            <div className="mx-auto w-full max-w-7xl space-y-6 p-6">
                        ...
                        <form onSubmit={submit} className="space-y-4">
                            ...
                            <div className="grid gap-2">
                                ...
                                <select
                                    ...
                                    value={data.type}
                                    onChange={(e) => {
                                        const typeVal = e.target.value as
                            ...
                            {data.type === 'multiple_choice' ? (
                                ...
                                <div className="grid gap-2">
                                    <Label htmlFor="correct_answer">
                                        Correct Answer Guideline / Keyword
                                    </Label>
                                    <Input
                                        id="correct_answer"
                                        value={data.correct_answer}
                ...
                <div className="w-full space-y-4">
                    {questions.map((question, index) => (
                        <div
                            key={question.id}
                            className="flex w-full flex-col justify-between gap-4 rounded-2xl border border-neutral-200 bg-white p-6 shadow-xs md:flex-row md:items-start dark:border-neutral-800 dark:bg-neutral-900"
                        >
                                    ...
                                    question.options && (
                                        <div className="grid gap-2 pl-4">
                                            {question.options.map((opt, i) => (
                                                ...
                                                >
                                                    <div
                                                        className={`size-2.5 rounded-full ${opt === question.correct_answer ? 'bg-green-500' : 'bg-neutral-300'}`}
                                                    />
                                                    <span
                                                        className={
                                                            opt ===
                            ...
                            <div className="mt-4 flex items-center gap-2 self-end md:mt-0 md:self-start">
                                <Button
                                    variant="ghost"
                                    size="icon"
                    ...
                    {questions.length === 0 && (
                        <div className="rounded-2xl border-2 border-dashed border-neutral-200 px-5 py-12 text-center dark:border-neutral-800">
